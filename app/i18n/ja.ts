...
export const ja: typeof en = {
  ...
  structuredDataGuide: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '<head> 内のどこかが慣例で、<body> の最後でも動きます。それより大事なのは「どのページに貼るか」で、ブロックは自分が説明しているページに置きます。',
      },
      {
  ...
  structuredData: {
    ...
    whereHeading: 'どこに貼るか',
    whereGeneral:
      'ブロックごと、そのページの <head> 内のどこかに貼ります。<head> を編集できない場合は <body> の最後でも構いません。WordPressならSEOプラグイン（Yoast、Rank Math、All in One SEO）のカスタム構造化データ欄かヘッダー挿入プラグイン、Shopify・Wix・STUDIOならページごとのカスタムコード／ヘッダー設定に入れます。',
