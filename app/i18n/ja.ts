...
export const ja: typeof en = {
  ...
  pdfMergerPage: {
    metaTitle: '複数ファイルを1つにまとめる - よしにゃにPDF結合｜無料・登録不要',
    metaDescription:
    ...
    lead: 'PDFを放り込んで、順番を決めて、1つのファイルとしてダウンロードするだけ。ファイルごとに使うページを選べて、一度に100ファイルまで扱えます。ブラウザ内だけで完結し、サーバーには送られないので、契約書や請求書でも安心して使えます。',
    privacyNote:
      'PDFはサーバーに送信されません。すべての処理はブラウザ内で完結します。',
  },
  pdfMerger: {
