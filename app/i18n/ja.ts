  ...
  imageCompressorGuide: {
    ...
    sections: [
      ...
      },
      {
        heading: '品質の決め方',
        body:
          '写真なら品質80あたりが出発点になります。容量の大半が落ちる一方で、違いは見つけにくいままです。細かい模様、画像内の文字、フラットなイラストは劣化が早く出るので、100%表示で確認してから決めてください。60を下回るとたいてい肉眼で分かるようになります。逆に90を超えると画質はほとんど改善せず容量だけ増えていきますが、100ちょうどのときだけWebPは可逆モードに切り替わり、元画像と完全に同一かつ99より小さくなることがあります。PNGには品質設定の代わりに色数の設定があります。PNGの圧縮そのものは可逆なので、軽くする唯一の方法が減色だからです。ロゴや図版なら、256色でも見た目をほとんど変えずに大幅に軽くできます。',
      },
      {
        heading: 'プライバシーと安全性',
        body:
